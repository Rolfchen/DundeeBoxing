...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    //TESTFLIGHT
    //UAT: remove at release
    [TestFlight setDeviceIdentifier:[[UIDevice currentDevice] uniqueIdentifier]];
    [TestFlight takeOff:@"ee855b1ebf8045514ded57dcdf208a54_NjgyMzA3MjAxMi0xMC0xNyAwMzowNzoxNy45MTA0NDY"];
     ...
     */
    WebViewController *boxingViewControl = [[WebViewController alloc] initWithHTML:@"boxingConfidence"];
    boxingViewControl.bannerImage = [UIImage imageNamed:@"AboutBanner.png"];
    boxingViewControl.titleString = @"Boxing Confidence";
    boxingViewControl.backButtonHidden = YES;
    UINavigationController *boxingNavController = [[UINavigationController alloc] initWithRootViewController:boxingViewControl];
    boxingNavController.title = @"Knowledge";
    boxingNavController.tabBarItem.image = [UIImage imageNamed:@"AboutIcon.png"]; //TEMP
    ...
    gymNavController.tabBarItem.image = [UIImage imageNamed:@"GymIcon.png"];
    
    //About
    AboutAuthorViewController *aboutViewControl = [[AboutAuthorViewController alloc] initWithNibName:@"AboutAuthorViewController" bundle:nil];
    aboutViewControl.title = @"About";
    aboutViewControl.tabBarItem.image = [UIImage imageNamed:@"TipsIcon.png"];
    
    self.tabController = [[UITabBarController alloc] init];
    [self.tabController setViewControllers:[NSArray arrayWithObjects:boxingNavController, comboNavController, youtubeNavController, gymNavController, aboutViewControl, nil]];
